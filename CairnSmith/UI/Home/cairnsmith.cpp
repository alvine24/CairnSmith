...
void CairnSmith::resizeEvent(QResizeEvent *e)
{
	if(m_Central_BluePrint_Design_Rendering){
	m_Central_BluePrint_Design_Rendering->m_ViewTabWidget->setStyleSheet(

	"QTabBar::tab { width: 25px; height: " + QString::number(centralWidget()->height()/3) + "px; }"
